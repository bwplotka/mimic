...
Do not add abstractions, opinions or validation into the providers as this should be done by an abstraction or the definition itself.
This avoids magic like the transforming of a property on a struct from one value to
